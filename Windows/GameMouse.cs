...
{
    /// <summary>
    /// Logic for applying mouse inputs to the game.
    /// </summary>
    public class GameMouse
    {
        ...
        public int X => Static.Game.IsActive ? _newState.X : -1;
        public int Y => Static.Game.IsActive ? _newState.Y : -1;
